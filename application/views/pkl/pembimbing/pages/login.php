...
<input type="hidden" name="data_action" id="data_action" value="LoginPembimbing" />
	...
	$(document).on('submit', '#login_form', function(event){
        ...
        $.ajax({
            ...
            success:function(data)
            {
                ...
                if($('#data_action').val() == "LoginPembimbing")
				{
					if(data.error == "true"){
						$('#success_message').html('<div class="alert alert-danger">Nip Atau Password Salah!</div>');
					}else{
						window.location.href="http://[::1]/pk_magang/pkl_pembimbing";
					}
				}
            }
        })
